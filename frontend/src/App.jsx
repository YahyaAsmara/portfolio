...
const Portfolio = () => {
  ...
  return (
    <div className="bg-[#0f0b0a] text-[#ffe5d6] min-h-screen font-mono overflow-x-hidden">
      {/* hero with extra negative space */}
      <section id="home" className="relative min-h-[95vh] flex items-center">
        <ThreeMinimal accent="#627e90ff" />
        <div className="relative z-10 w-full px-5 pt-24 md:pt-32">
          <div className="text-center mb-10 md:mb-16">
            <h1 className="text-3xl sm:text-5xl md:text-6xl tracking-tight text-[#a7d3ec]">yahya asmara</h1>
            <p className="text-xs sm:text-sm md:text-base text-[#cfe6f3] mt-3">cs @ university of calgary · full‑stack · three.js</p>
          </div>
      ...
      {currentSection !== 0 && (
        <button
          ...
          className="fixed bottom-5 right-5 z-50 rounded-full bg-[#74b0d6] text-[#000000] hover:bg-[#8dc0de] transition-colors shadow-[0_10px_30px_rgba(116,176,214,.25)] px-3 py-2 text-xs md:text-sm border border-[#0b1e2a]/10"
        >
          home
        </button>
      )}
  ...
  <section id="about" className="pt-20 md:pt-28 pb-12 md:pb-16 px-5 md:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-base md:text-lg text-[#a7d3ec] mb-8 md:mb-12">about</h2>
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-stretch">
            <div className="order-2 md:order-1">
              <div className="bg-black/40 border border-[#74b0d6]/25 rounded p-5 md:p-7 leading-relaxed text-[#ffe5d6]">
...
interests = ['embedded', 'graphics', 'data']`}</pre>
              ...
              <div className="order-1 md:order-2 h-full">
                <div className="h-full -mt-14 md:-mt-20">
  ...
  <section id="experiences" className="pt-8 md:pt-12 pb-12 md:pb-16 px-5 md:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-base md:text-lg text-[#a7d3ec] mb-6 md:mb-8">experiences</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-black/40 border border-[#74b0d6]/25 rounded p-4 md:p-5">
      ...
      {/* projects */}
      <section id="projects" className="py-20 md:py-36 px-5 md:px-8 bg-black/30 border-y border-[#74b0d6]/20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-base md:text-lg text-[#a7d3ec] mb-10">projects</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {projects.map((project) => (
              <div key={project.name} className="bg-black/40 border border-[#74b0d6]/25 p-5 md:p-6 rounded hover:border-[#74b0d6]/40 transition-colors">
                ...
                <div className="flex flex-wrap gap-2 mb-3">
                  {project.tech.map((tech) => (
                    <span key={tech} className="text-[10px] bg-[#74b0d6]/10 border border-[#74b0d6]/25 px-2 py-0.5 rounded">{tech}</span>
                  ))}
                </div>
                <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-xs border-b border-[#74b0d6]/40 hover:border-[#74b0d6]/70 text-[#ffe5d6]">View Project →</a>
              </div>
            ))}
          </div>
          <h3 className="text-sm md:text-base text-[#a7d3ec] mt-10 md:mt-16 mb-4 md:mb-6">working on</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {workingOn.map((project) => (
              <a key={project.name} href={project.link} target="_blank" rel="noopener noreferrer" className="bg-black/40 border border-[#74b0d6]/25 rounded p-4 hover:border-[#74b0d6]/40 transition-all duration-300">
      ...
      <section id="contact" className="py-20 md:py-36 px-5 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-base md:text-lg text-[#a7d3ec] mb-8">contact</h2>
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-8">
            <a href="mailto:yahya16005@gmail.com" className="text-xs md:text-sm border-b border-[#74b0d6]/40 hover:border-[#74b0d6]/70 text-[#ffe5d6]">Email</a>
            <a href="https://github.com/YahyaAsmara" target="_blank" rel="noopener noreferrer" className="text-xs md:text-sm border-b border-[#74b0d6]/40 hover:border-[#74b0d6]/70 text-[#ffe5d6]">GitHub</a>
            <a href="https://linkedin.com/in/yahya-asmara" target="_blank" rel="noopener noreferrer" className="text-xs md:text-sm border-b border-[#74b0d6]/40 hover:border-[#74b0d6]/70 text-[#ffe5d6]">LinkedIn</a>
          </div>
        </div>
      </section>

      {/* footer */}
      <footer className="py-12 md:py-16 px-6 border-t border-[#74b0d6]/20">
